...
echo "<div id='contents'>";
    ...
    if($q1->rowCount() == 0){
        ...
        while($idea = $q1->fetch(PDO::FETCH_ASSOC)){
            ...
            <h1>".$idea['titre']."</h1>
            <p>".$idea['contenue']."</p>
            <p>Published on : ".$idea['date_idea']."</p>
            <br>";
            ...
            if(isset($_SESSION['identifiant'])){
                ...
                if($q2->fetch() == !true){
                    ...
                    <button onclick="PopUpVoteFor('<?=$idea['id_idea']?>');">Voted for</button>
                    <button onclick="PopUpVoteAgainst('<?=$idea['id_idea']?>');">Voted against</button>

                    <?php

                }else{
                
                    echo "<p>This idea was voted</p>";
