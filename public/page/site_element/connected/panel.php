...
echo "<div id='contents' class='animpage'>";
    ...
    echo "<div class='app-elements-other'>
            ...
            <input type='submit' id='fav' value='Gérer mes favoris'>
            </a>
            </div>";
    ...
    if($q->rowCount() == 0) {
        ...
        echo "<p>Vous n'avez actuellement aucune application définie comme favoris</p>";
    ...
    echo "<div class='app-elements'>
        ...
        <p>Mon identifiant : " . $_SESSION['identifiant'] . "</p>";

    if(isset($_SESSION['identifiant']) && in_array($_SESSION['identifiant'], $group_admin)) {
        echo "<a href='index.php?page=admin'><p><span style='color:red'>Interface d'administration </span></p></a>";
    }
    ...
    echo "<p>Une idée ? Des propositions à nous soumettre ? Cliquer ci-dessous.
        <form method='post' action='index.php?page=new_idea'>
        <input type='submit' name='new_idea' id='new_idea' value='Poster une idée'>
        </form>
        </p>";
    ...
    if ($q2->rowCount() == 0) {
        ...
        while($idea = $q2->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<a href='index.php?page=idea'>
                <h3>" . $idea['titre'] . "</h3>
                <p>Publiée le <span style='color:black'>: " . $idea['date_idea'] . "</p>
                </a>";
        }
    }
