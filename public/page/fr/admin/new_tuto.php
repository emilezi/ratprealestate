...
echo "<div class='elements'>";
    ...
    <form enctype="multipart/form-data" method="post">
        ...
        <input type="text" name="title" maxlength="50" size="50" placeholder='Saisissez un titre'>
        <br/><br/>
        <h3>Selectionner une categorie</h3>
        <select name='category' size='1'>
        <option value='Non categorise'>Non catégorisé
        <option value='Outlook'>Outlook
        <option value='Teams'>Teams
        <option value='Onedrive'>Onedrive
        <option value='Mise à jour'> Mise à jour
        <option value='Périphérique'> Périphérique
        <option value='Sécurité informatique'>Sécurité informatique
        ...
        <input type="submit" name="submit" value="Poster" onclick="editutoresult();">
        <a href='index.php?page=admin&action=new_upload'><input type="button" name="import" value="Importer un élément"></a>
    </form>
